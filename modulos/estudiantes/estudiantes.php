            ...
            <div class="col-sm-12 col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="addEstudiante.php" class="btn btn-primary"><i class='fa fa-user'></i> Crear Estudiante</a>
                    </div>
                    <div class="card-body">
                        <?php 
                            $mensajes = array(
                                ...
                                <?php 
                                    ...
                                    foreach($result as $row) {
                                        echo "<tr>
                                                ...
                                                <td>
                                                    <a href='../notas/notas.php?id=".$row['id']."' class='btn btn-success btn-sm'><i class='fa fa-book'></i></a>
